      ...
      <div className="max-w-7xl mx-auto px-6 py-12 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
        ...
        <div>
          ...
          <div className="text-white/70 text-sm space-y-2 ">
            ...
            <p>   <MdLocationPin size={25} className='inline-block text-white' /> Akurdi, Pune 411035</p>
            <p > Phone: 9096809820</p>
            <p> <MdOutlineMailOutline size={20} className='inline-block text-white mr-2'/>Email: rohitkhobare2005@gmail.com</p>
          </div>
        </div>
