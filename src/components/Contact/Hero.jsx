...
const Hero = () => {
  ...
  const contactInfo = [
    ...
    },
    {
      icon: Mail,
      title: "E-Mail",
      details: "rohitkhobare2005@gmail.com",
      color: "bg-orange-500",
    },
  ];
    ...
    <div className="w-full bg-gray-50">
      ...
      <section className="py-16 md:py-24 px-4 sm:px-6 lg:px-8">
        <div className="max-w-6xl mx-auto">
            ...
            <div className="lg:col-span-1">
              <div className="bg-white rounded-2xl p-8 shadow-lg">
                ...
                <p className="text-gray-600 text-sm md:text-base mb-8 leading-relaxed">
                  ...
                  sit amet accumsan eros, sit amet eiusmod tempor incididunt ut
                  ...
                  {contactInfo.map((item, index) => {
                    ...
                    return (
                      <div key={index} className="flex items-start gap-4">
                        <div
                          className={`${item.color} p-3 rounded-full flex-shrink-0 mt-1`}
                        >
          ...
          <button className="p-2 m-4 bg-white hover:bg-orange-400  hover:text-white rounded-md font-semibold cursor-pointer ">
            See Location
          </button>
        </div>
      </section>
